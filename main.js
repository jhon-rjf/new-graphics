...
function createExhibits() {
  ...
  const venusTexture = textureLoader.load('./graphicsteam/textures/venus.jpg');
  ...
  const brickTexture = textureLoader.load('./graphicsteam/textures/brick.jpg');
  ...
  const ballTexture = textureLoader.load('./graphicsteam/textures/ball.png');
